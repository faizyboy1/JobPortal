...
@if(in_array("add_category", $userPermissions))
    ...
    <a href="{{ route('admin.job-company.create') }}" class="btn btn-dark btn-sm m-l-15"><i class="fa fa-plus-circle"></i> @lang('app.createNew')</a>
    @endsection
@endif 
...
<script>
    var table = $('#myTable').dataTable({
            ...
            // processing: true,
            serverSide: true,
            ajax: '{!! route('admin.job-company.data') !!}',
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.job-company.destroy',':id') }}";
