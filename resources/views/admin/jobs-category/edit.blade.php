    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="editCategory" class="ajax-form">
                    @csrf @method('PUT')

                    <div class="form-group">
                        <label for="company_name">@lang('modules.accountSettings.companyName')</label>
                        <input type="text" class="form-control" id="company_name" name="company_name" value="{{ $categories->company_name }}">
                    </div>
...
<script>
    // For select 2
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route("superadmin.job-category.update", $categories->id)}}',
