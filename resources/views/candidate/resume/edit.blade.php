...
@endphp
    <div class="container">
        ...
        <form action="{{ url('candidate/resume/'.auth()->user()->candidateResume->id) }}" method="POST" class="form" enctype="multipart/form-data"
            ...
            <div style="position: relative; padding:1.5rem " class="box-container">
                ...
                <div class="box">
                    ...
                    <div style="display: flex; justify-content:space-between; ">
                        ...
                        <div class="form__group">
                            ...
                            placeholder="Ffirst Name*"
                            name="first_name"
                            required
                            value="{{ $candidateResume->first_name }}"
                            >
                        ...
                        <div class="form__group">
                            ...
                            name="last_name"
                            value="{{  $candidateResume->last_name }}"
                            >
                    ...
                    <div style="display: flex; justify-content:space-between; ">
                        <div class="form__group">
                            ...
                            required
                             class="form_group-input" name="country" id="country">
                             <option selected disabled>-- Select Country --</option>
                                @foreach ($countries_list as $key=>$country)
                                    <option value="{{ $candidateResume->country ? $candidateResume->country : $country['name'] }}"
                                    data-index="{{ $key }}"
                                        >
                                        {{ $country['name'] }}
                                    </option>
                        ...
                        <div class="form__group">
                            ...
                            name="zip_code"
                            value="{{ $candidateResume->zip_code }}"
                            >
                    ...
                    <div style="display: flex; justify-content:space-between; ">
                        <div class="form__group">
                            ...
                            name="country_code"
                            value="{{ $candidateResume->country_code }}"
                            >
                    ...
                    {{-- <div>
                        ...
                        <img src="https://images.unsplash.com/photo-1586962358070-16a0f05b8e67?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"  class="rounded-circle mb-4"  alt="Cinque Terre" width="350" height="350"> 
                    </div> --}}
                </div>
                <div class="box2">
                    <h1 style="text-align: center">Objective</h1>
                        <div class="form__group">
                            ...
                            name="objective"
                            value=""
                            >{{ $candidateResume->objective }}</textarea>
                            {{-- <label for="first" class="form_group-label">
                                First Name
                            </label> --}}
                    </div>
                ...
                <div class="box3" id="#box3">
                    ...
                    <div id="education_fields">
                        @foreach ($educations as $education)
                            <div class= "{{($loop->iteration > 1) ? "d-flex justify-content-between removeclass{$loop->iteration}" : "d-flex justify-content-between "  }}">
                                <div class="form__group">
                                ...
                                @else
                                <div class="input-group-append" style="padding: 1rem 0" > 
                                    <button class="btn btn-danger" style="padding: 0 2rem;" type="button" id="remove_education_fields({{ $loop->iteration }})"
                                         onclick="remove_education_fields({{ $loop->iteration }});"
                                         >
                ...
                <div class="box4">
                    ...
                    <div id="certificate_fields">
                        ...
                        <div class="{{($loop->iteration > 1) ? "d-flex justify-content-between removeclassCertificate{$loop->iteration}" : "d-flex justify-content-between "  }}">
                            <div class="form__group">
                            ...
                            <div class="form__group">
                                ...
                                class="form_group-input" 
                                value="{{$certificate->certification_year  }}"
                                placeholder="Year">
                            ...
                            <div class="form__group">
                                ...
                                class="form_group-input" 
                                value="{{ $certificate->certification_institute }}"
                                placeholder="University/School">
                            ...
                            @else
                            <div class="input-group-append" style="padding: 1rem 0" > 
                                <button class="btn btn-danger" style="padding: 0 2rem;" type="button"
                                     onclick="remove_certificate_fields({{ $loop->iteration }});"
                                     >
                                        <i class="fa fa-minus"></i>
                                </button>
                                </div> 
                ...
                <div class="box5">
                    ...
                    <div id="awards_fields">
                        ...
                        <div class="{{($loop->iteration > 1) ? "d-flex justify-content-between removeclassAwards{$loop->iteration}" : "d-flex justify-content-between "  }}">
                            <div class="form__group">
                            ...
                            <div class="input-group-append" style="padding: 1rem 0" > 
                                <button class="btn btn-danger" style="padding: 0 2rem;" type="button"
                                     onclick="remove_awards_fields({{ $loop->iteration }});"
                                     >
                                        <i class="fa fa-minus"></i>
                                </button>
                                </div> 
                ...
                <div class="box6">
                    ...
                    <div id="language_fields">
                        ...
                        <div class="{{($loop->iteration > 1) ? "d-flex justify-content-between removeclassLanguage{$loop->iteration}" : "d-flex justify-content-between "  }}">
                            <div class="form__group">
                            ...
                            <div class="input-group-append" style="padding: 1rem 0" > 
                                <button class="btn btn-danger" style="padding: 0 2rem;" type="button"
                                     onclick="remove_language_fields({{ $loop->iteration }});"
                                     >
                                        <i class="fa fa-minus"></i>
                                </button>
                                </div> 
                ...
                <div class="box7">
                    ...
                    <div id="skill_fields">
                        ...
                        <div class="{{($loop->iteration > 1) ? "d-flex justify-content-between removeclassSkill{$loop->iteration}" : "d-flex justify-content-between "  }}">
                            <div class="form__group">
                            ...
                            <div class="input-group-append" style="padding: 1rem 0" > 
                                <button class="btn btn-danger" style="padding: 0 2rem;" type="button"
                                     onclick="remove_skill_fields({{ $loop->iteration }});"
                                     >
                                        <i class="fa fa-minus"></i>
                                </button>
                                </div> 
                ...
                <div class="box8">
                    ...
                    <div id="experience_fields">
                        ...
                        <div class="{{($loop->iteration > 1) ? " removeclassExperience{$loop->iteration}" : ""  }}">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="form__group ">
                                    <input type="hidden" name="present[{{ $loop->iteration -1 }}]" value="null" >
                                    <input  {{ $experience->present === "Present" ? 'checked' : "" }}
                                    type="checkbox" id="present{{ $loop->iteration -1 }}"
                                    name="present[{{ $loop->iteration -1 }}]" onclick="disableCheck({{ $loop->iteration -1 }})"  >
                                    <label for="present{{ $loop->iteration -1 }}">Present</label>
                                </div>
                                <div class="form__group d-flex align-items-center">
                                    <input type="hidden" name="end_date[{{ $loop->iteration -1 }}]" value="null" >
                                    <input  type="date" id="end_date{{ $loop->iteration -1 }}" name="end_date[{{ $loop->iteration -1 }}]"  
                                    class="form_group-input"
                                    {{ $experience->present === "Present" ? 'disabled': "" }}
                                    @if ($experience->end_date)
                                    value="{{ $experience->end_date }}"
                                    {{-- value="<?phpechodate('Y-m-d',strtotime($experience->end_date))?>" --}}
                                    @endif 
                                    
                                    placeholder="Ending Date">
                                    <label for="end_date{{ $loop->iteration -1 }}" class="form_group-label" >
                                        Ending Date
                                    </label>
                            ...
                            @else
                            <div class="input-group-append" style="padding: 1rem 0; margin-left: 1rem;" > 
                                <button class="btn btn-danger" style="padding:  1.5rem 7rem" type="button" onclick="remove_experience_fields({{$loop->iteration}});">
                                        <i class="fa fa-minus"></i>
                                </button>
                            </div>
                            @endif
...
<script>
    ...
    $("#submit").hide()
        ...
        if(stack == 4){
            let certification_name =$("input[name='certification_name[]']").map(function(){return $(this).val();}).get() ;
            let certification_year =$("input[name='certification_year[]']").map(function(){return $(this).val()}).get();
            let certification_institute=$("input[name='certification_institute[]']").map(function(){return $(this).val()}).get();
            if(certification_name.length > 1){
                for(let i=0; i < certification_name.length; i++){
                if( (certification_name[i].length < 2 )||
                  (certification_year[i].length < 4  )||
                   (certification_institute[i].length < 2 ) ) {
                    check=false;
                    stack = 3;
                    break;
                }
        ...
        if(stack == 5){
            let award_name =$("input[name='award_name[]']").map(function(){return $(this).val();}).get() ;
            let award_year =$("input[name='award_year[]']").map(function(){return $(this).val()}).get();
            let award_institute=$("input[name='award_institute[]']").map(function(){return $(this).val()}).get();
            
            if(award_name.length > 1){
                    for(let i=0; i < award_name.length; i++){
                    if( award_name[i].length < 2 ||
                    award_year[i].length < 4  ||
                    award_institute[i].length < 2  ) {
                        check=false;
                        stack = 4;
                        break;
                    }
...
var room ={{ $educations->count() }};
console.log({Experience:"{{ $experiences->count() }}"})
var room_certificate = {{ $certifications->count() }};
var room_awards = {{ $awards->count()  }};
var room_language = {{ $languages->count()  }};
var room_skill = {{ $skills->count()  }};
var room_experience = {{ $experiences->count() -1 }};
...
// $('#remove_education_fields').click(function (rid) {
    ...
    <div class="removeclassExperience${room_experience}">
        <div class="d-flex justify-content-between ">
            ...
            <div class="form__group ">
                ...
                <input   type="checkbox" id="present${room_experience}" name="present[${room_experience}]"
                onclick="disableCheck(${room_experience})" >
